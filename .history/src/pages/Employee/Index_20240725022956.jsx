            ...
            },
            {
                ...
                cell: ({ row }) => {
                    if (row.original.working_hours == null) {
                        ...
                        return (
                            <>
                              {`Type: ${row.original.working_hours.type} Workng Time: ${row.original.working_hours.startpartTime}-${row.original.working_hours.endpartTime} Part Type: ${row.original.working_hours.partType}-${row.original.working_hours.endBreakTime}`}
                            </>
                        );
                    }
