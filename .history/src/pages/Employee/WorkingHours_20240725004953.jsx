...
const WorkingHours = () => {
    ...
    const dataFetch = async () => {
        try {
            ...
            formik.setFieldValue("type", managerData.department_id);
            formik.setFieldValue("startTime", managerData.manager_id);
            formik.setFieldValue("endTime", managerData.status);
            formik.setFieldValue("startBreakTime", managerData.id);
            formik.setFieldValue("endBreakTime", managerData.id);
            formik.setFieldValue("partType", managerData.id);
            formik.setFieldValue("startpartTime", managerData.id);
            formik.setFieldValue("endpartTime", managerData.id);
