            ...
            },
            {
                ...
                cell: ({ row }) => {
                    if (row.original.working_hours == null) {
                        ...
                        return (
                            <>
                              {`Type: ${row.original.working_hours.type} WorkngTime: ${row.original.working_hours.startpartTime}-${row.original.working_hours.endpartTime} PartType: ${row.original.working_hours.partType}`}
                            </>
                        );
                    }
