...
const WorkingHours = () => {
    ...
    const dataFetch = async () => {
        try {
            ...
            formik.setFieldValue("type", managerData.type== "null" ? '' : type);
            formik.setFieldValue("startTime", managerData.startTime== "null" ? '' : startTime);
            formik.setFieldValue("endTime", managerData.endTime== "null" ? '' : endTime);
            formik.setFieldValue("startBreakTime", managerData.startbreakTime== "null" ? '' : startbreakTime);
            formik.setFieldValue("endBreakTime", managerData.endBreakTime== "null" ? '' : endBreakTime);
            formik.setFieldValue("partType", managerData.partType== "null" ? '' : partType);
            formik.setFieldValue("startpartTime", managerData.startpartTime== "null" ? '' : startpartTime);
            formik.setFieldValue("endpartTime", managerData.endpartTime== "null" ? '' : endpartTime);
