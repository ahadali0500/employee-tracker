...
const WorkingHours = () => {
    ...
    const dataFetch = async () => {
        try {
            ...
            formik.setFieldValue("startTime", managerData.startTime);
            formik.setFieldValue("endTime", managerData.endTime);
            formik.setFieldValue("startBreakTime", managerData.startbreakTime);
            formik.setFieldValue("endBreakTime", managerData.endBreakTime);
            formik.setFieldValue("partType", managerData.partType);
            formik.setFieldValue("startpartTime", managerData.startpartTime== "null" ? '' : startpartTime);
            formik.setFieldValue("endpartTime", managerData.endpartTime);
