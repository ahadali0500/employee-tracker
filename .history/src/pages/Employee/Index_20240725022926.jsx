            ...
            },
            {
                ...
                cell: ({ row }) => {
                    if (row.original.working_hours == null) {
                        ...
                        return (
                            <>
                              {`Type: ${row.original.working_hours.type} Workng Time: ${row.original.working_hours.startTime}-${row.original.working_hours.endTime} Break Time: ${row.original.working_hours.startBreakTime}-${row.original.working_hours.endBreakTime}`}
                            </>
                        );
                    }else if(row.original.working_hours.type=="part") {
                        return (
                            <>
                              {`Type: ${row.original.working_hours.type} Workng Time: ${row.original.working_hours.startpartTime}-${row.original.working_hours.endpartTime} Break Time: ${row.original.working_hours.startBreakTime}-${row.original.working_hours.endBreakTime}`}
                            </>
                        );
                    }
