...
function Map() {
  ...
  const savePolygon = async (polygon) => {
    ...
    toast.promise(
      ...
      {
        loading: 'Saving...',
        success: 'Selected area saved successfully!',
  ...
  const adjustMapView = () => {
    if (polygons.length > 0) {
      ...
      setMapZoom(14); // Example zoom level for user location
    }
  };
  ...
  return (
    <div>
      <button  color="primary" outline onClick={getLocation}>Get Location</button>
