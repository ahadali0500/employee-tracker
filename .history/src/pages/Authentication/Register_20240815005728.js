    ...
    onSubmit: async (values, { resetForm, setFieldError}) => {
      try {
        ...
        if (error.response.status==422) {
          ...
          setFieldError('logo', error.response.data.errors.image?.[0]);
          setFieldError('name', error.response.data.errors.name?.[0]);
          setFieldError('password', error.response.data.errors.password?.[0]);
          setFieldError('description', error.response.data.errors.description?.[0]);
        }else{
                  ...
                  <Row>
                    <Col className="col-7">
                      <div className="text-dark p-4">
                        ...
                        <h6 className="text-dark">Registeration Form</h6>
                      </div>
                    </Col>
                    <Col className="col-5 align-self-end">
                      <img src="/connect-sim.png" alt="" style={{width:'100px', marginBottom:'0px'}}  />
                    </Col>
                  </Row>
                </div>
