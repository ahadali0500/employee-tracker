...
const Attendance = () => {
    ...
    const datafetch = async () => {
        ...
        data.append('manager_id', id);
        const response = await axios.post(`${API_URL}/company/manager/attendance` , data, {
            headers: {
    ...
    const columns = useMemo(
        () => [
            ...
            //                 <li>
            //                     <Link
            //                         to={`/manager/update/${cellProps.row.original.id}`}
            ...
            <div className="container-fluid">
                {loading ?
                    ...
                    <>
                        {data.length > 0 ?
                            <>
                                <Breadcrumbs title={`${details.name}  Attendance`} breadcrumbItem={`${details.name}  Attendance`} />
                                <TableContainer
                                    columns={columns}
                                    data={data || []}
                                    isGlobalFilter={true}
                            ...
                            <>
                                <center>
                                    <div style={{ marginTop: '10%' }} >
                                        ...
                                        No Attendance exits in our records
                                    </div>
                                </center>
                            </>
                        }
